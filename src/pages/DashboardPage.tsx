        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    >
                        <Building2 className="h-6 w-6 text-brand-600 mb-2" />
                        <h3 className="font-semibold text-gray-900">Browse Clubs</h3>
                        <p className="text-sm text-gray-600">Explore all available clubs</p>
                    </button>
