...
export const FormBuilderPage = () => {
    ...
    const handleAIGenerate = async () => {
        ...
        setGenerating(true);
        try {
            const { title, description, questions, theme, settings } = await generateFormSchema(prompt);
            ...
            if (questions[0]?.id === 'fallback_1') {
                toast.error("AI is busy (Quota Limit). Loaded a basic template.");
            } else {
