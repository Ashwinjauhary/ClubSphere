                                ...
                                {users.map((user, index) => (
                                    <tr key={user.id} className={`group hover:bg-gray-50 transition-colors ${index < 3 ? 'bg-yellow-50/30' : ''}`}>
                                        <td className="px-6 py-4 text-center">
                                            {index === 0 && <Crown className="h-6 w-6 text-yellow-500 mx-auto fill-yellow-500" />}
                                            {index === 1 && <Medal className="h-6 w-6 text-gray-400 mx-auto" />}
                                            {index === 2 && <Medal className="h-6 w-6 text-amber-700 mx-auto" />}
                                            {index > 2 && <span className="text-gray-400 font-bold block w-6 mx-auto">#{index + 1}</span>}
                                        </td>
                                        <td className="px-6 py-4">
                                            <div className="flex items-center">
                                                <div className="h-10 w-10 rounded-full bg-brand-100 flex items-center justify-center text-brand-700 font-bold mr-4 border-2 border-white shadow-sm overflow-hidden">
                                                    {user.avatar_url ? (
                                                ...
                                                <div>
                                                    ...
                                                    {index === 0 && <div className="text-xs text-yellow-600 font-medium">Current Champion</div>}
                                                </div>
                                            </div>
                                        </td>
                                        <td className="px-6 py-4 text-center">
                                        ...
                                        <td className="px-6 py-4 text-right">
                                            <div className="flex items-center justify-end font-mono font-bold text-gray-900">
                                                <Zap className="h-4 w-4 text-yellow-500 mr-1 fill-yellow-500" />
