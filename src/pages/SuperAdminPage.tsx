        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="bg-white border-b border-gray-200 shadow-sm overflow-hidden">
                <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8">
                    <nav
                        className="flex space-x-4 sm:space-x-8 overflow-x-auto scrollbar-hide py-2 -mx-2 px-2"
                        aria-label="Tabs"
                        style={{
                            scrollbarWidth: 'none',
                        ...
                        {tabs.map((tab) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`
                                        flex items-center gap-2 py-3 px-3 sm:px-4 border-b-2 font-medium text-xs sm:text-sm whitespace-nowrap transition-colors flex-shrink-0
                                        ${activeTab === tab.id
