                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 overflow-hidden">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        {events.length === 0 ? (
                            ...
                            <div key={event.id} onClick={() => setSelectedEvent(event)} className="p-4 border rounded-lg hover:bg-gray-50 transition-colors cursor-pointer">
                        ...
                        <div className="p-6">
                            <div className="flex justify-between items-start mb-4">
                                <div>
                                    ...
                                    <p className="text-gray-500">Organized by {selectedEvent.clubs?.name}</p>
                                </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="bg-gray-50 p-3 rounded-md">
                                        ...
                                        <p className="text-sm font-medium">{format(new Date(selectedEvent.start_time), 'PPp')}</p>
                                    </div>
                                    <div className="bg-gray-50 p-3 rounded-md">
